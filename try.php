...
if (isset($_SESSION['login'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $conn->prepare("SELECT name, password, email FROM user WHERE email = ? AND status = true");
        if ($stmt === false) {
        ...
        if ($res && $res->num_rows > 0) {
            ...
            $name1 = $rows['name']; // Make sure the column name is correct
            ...
            try {
                ...
                $mail->Body = 'Dear ' . $name1 . '<br> You recently requested to reset your password<br> Password: ' . $password1 . '<br><br> Thank you<br>Team ' . $appname;
                ...
                echo "<script>alert('Error in sending email. Mailer Error: {$mail->ErrorInfo}');</script>";
            }
        } else {
            ...
            <div class="card-body my-4">
                <form action="" method="post">
                    ...
                    <div class="form-group mt-3">
                        <input type="submit" name="submit" value="Reset" class="btn btn-outline-danger float-right login_btn">
                    </div><br>

        ...
        <nav class="navbar navbar-expand-lg stroke">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?php if($_SERVER['REQUEST_URI']=='/bug-tracking/build.php'){echo 'active';} else if($_SERVER['REQUEST_URI']=='/bug-tracking/add-build.php'){echo 'active';}?>">
                        <a class="nav-link" href="build.php">Build</a>
                    </li>

                    <li class="nav-item <?php if($_SERVER['REQUEST_URI']=='/bug-tracking/program.php'){echo 'active';}?>">
                    ...
                    <li class="nav-item dropdown <?php if($_SERVER['REQUEST_URI']=='/bug-tracking/admin-profile.php'){echo 'active';} else if($_SERVER['REQUEST_URI']=='/bug-tracking/admin-setting.php'){echo 'active';}?>">
                        ...
                        <div class="dropdown-menu drop-3">
                            <div class="profile d-flex mr-o">
                                ...
                                <a class="dropdown-item mt-3" href="programmer-profile.php"><i class="fa fa-user mr-3"></i>Profile</a>
                                <a class="dropdown-item" href="programmer-settings.php"><i class="fa fa-cog mr-3"></i>Settings</a>
